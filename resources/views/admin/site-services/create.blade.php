...
<div class="box">
    ...
    <form action="{{route('admin.site.services.store')}}" method="POST" >
        @csrf
    <div class="panel-heading">
        <h5 class="panel-title">العنوان</h5>
        <input type="text" name="title" class="form-control input-lg"  data-show-upload="false" data-show-caption="true" data-show-preview="true">
        @error('title')
