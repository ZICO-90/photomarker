      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{route('admin.services.create')}}"><i class="fa fa-circle-o"></i> إنشاء خدمة</a></li>
            <li><a href="{{route('admin.services.index')}}"><i class="fa fa-circle-o"></i> عرض الكل</a></li>
          </ul>
        </li>
        <li>
